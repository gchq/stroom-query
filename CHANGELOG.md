...
## [v4.0-beta.67] - 2020-05-06

* Change `ExpressionTerm` and `ExpressionOperator` back to use Boolean instead of boolean for enabled.


## [v4.0-beta.66] - 2020-04-30

* Change `ExpressionTerm` to use boolean instead of Boolean for enabled.


## [v4.0-beta.65] - 2020-04-30

* Change `ExpressionTerm` to use boolean instead of Boolean for enabled.


## [v4.0-beta.64] - 2020-04-16
...
* Change `ExpressionItem` to use boolean instead of Boolean for enabled.
...
[Unreleased]: https://github.com/gchq/stroom-query/compare/v4.0-beta.70...HEAD
...
[v4.0-beta.65]: https://github.com/gchq/stroom-query/compare/v4.0-beta.64...v4.0-beta.65
[v4.0-beta.64]: https://github.com/gchq/stroom-query/compare/v4.0-beta.63...v4.0-beta.64
[v4.0-beta.63]: https://github.com/gchq/stroom-query/compare/v4.0-beta.62...v4.0-beta.63
...
[v4.0-beta.58]: https://github.com/gchq/stroom-query/compare/v4.0-beta.57...v4.0-beta.58
...
[v4.0-beta.53]: https://github.com/gchq/stroom-query/compare/v4.0-beta.52...v4.0-beta.53
[v4.0-beta.52]: https://github.com/gchq/stroom-query/compare/v4.0-beta.51...v4.0-beta.52
[v4.0-beta.51]: https://github.com/gchq/stroom-query/compare/v4.0-beta.50...v4.0-beta.51
[v4.0-beta.50]: https://github.com/gchq/stroom-query/compare/v4.0-beta.49...v4.0-beta.50
[v4.0-beta.49]: https://github.com/gchq/stroom-query/compare/v4.0-beta.48...v4.0-beta.49
[v4.0-beta.48]: https://github.com/gchq/stroom-query/compare/v4.0-beta.47...v4.0-beta.48
